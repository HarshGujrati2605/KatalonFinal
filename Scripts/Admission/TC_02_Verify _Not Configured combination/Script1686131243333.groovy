...
CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Admission/TC_02_Verify_Not Configured combination/Admission setup option'), 
    'Admission setup option')
...
CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Admission/CommonObjects/Row Selection'), 'First row from data')
...
CustomKeywords.'CommonActions.selectDropdownOptionCustom'(findTestObject('Object Repository/Admission/TC_02_Verify_Not Configured combination/List of dropdown'), 
    GlobalVariable.AssesmentProcessName)
