...
CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Admission/TC_05_Verify selection batch/Selection intake'), "selection radio button")
