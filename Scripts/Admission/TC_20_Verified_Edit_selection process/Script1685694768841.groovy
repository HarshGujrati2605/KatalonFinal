...
CustomKeywords.'CommonActions.clickOnElementAndTypeText'(findTestObject('Object Repository/Admission/TC_20_Verified_Edit_selection process/Remark'), 
    'Test Automation remark', 'Remark field')
...
CustomKeywords.'CommonActions.elementPresent'(findTestObject('Object Repository/Admission/TC_01_ Pre-requisites for Admission/Record added alert'), 
    'Assesment name added / updated alert')
