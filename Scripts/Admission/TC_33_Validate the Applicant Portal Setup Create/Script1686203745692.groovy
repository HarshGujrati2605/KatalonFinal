...
CustomKeywords.'CommonActions.clickOnElementAndTypeText'(findTestObject('Object Repository/Admission/TC_33_Validate the Applicant Portal Setup Create/setup name'),"Automation Learning",'Setup name filed')
