...
CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Program and courses/TC_03_Validate _Edit_Program/Row selection'), 
    'select first rwo')

CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Program and courses/TC_03_Validate _Edit_Program/Edit button'), 
    'Edit button')

WebUI.delay(4)

CustomKeywords.'CommonActions.clickOnElementAndTypeText'(findTestObject('Object Repository/Program and courses/TC_03_Validate _Edit_Program/Comments'), 
    'ALM Created', 'remark filed')
