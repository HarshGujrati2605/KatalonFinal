...
CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Program and courses/TC_04_Verified_View_Program/ROW selection'),'select first row')

CustomKeywords.'CommonActions.elementClick'(findTestObject('Object Repository/Program and courses/TC_04_Verified_View_Program/View button'), 
    'View button')

CustomKeywords.'CommonActions.elementPresent'(findTestObject('Object Repository/Program and courses/TC_04_Verified_View_Program/Header'), 
    'program header')
